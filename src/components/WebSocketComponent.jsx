  ...
  useEffect(() => {
    ...
    ws.onopen = () => {
      ...
      const initialData = {
        ...
        actid: "KE0070",
        susertoken:
          "eyJhbGciOiJIUzI1NiJ9..dVa6YUtTK3Slg3FrZXa3dJsJHEKFgo0E114xNnps5vQ",
        source: "API",
      };
