...
import { FaCog, FaChevronDown, FaUser, FaBars, FaTimes,FaSignOutAlt } from 'react-icons/fa';
        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-40 bg-white rounded-lg shadow-lg py-2 text-gray-800">
              <button className="w-full px-4 py-2 flex items-center text-sm hover:bg-gray-100">
                <FaUser className="mr-2" /> My Profile
              </button>
              <button className="w-full px-4 py-2 flex items-center text-sm hover:bg-gray-100 border-t">
                Sign Out
              </button>
            </div>
          )}
